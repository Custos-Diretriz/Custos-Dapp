...
export const Sidebar = ({ children, open, setOpen }: { children: React.ReactNode, open: boolean, setOpen: (open: boolean) => void }) => {
  return (
    <aside
      className={cn(
...
export const SidebarLink = ({ link, open }: { link: any, open: boolean }) => {
