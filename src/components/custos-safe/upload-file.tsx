...
const UploadFile = ({ setSelectedFiles }) => {
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    ...
    try {
      ...
      setError(typeof err === "string" ? err : "An error occurred while uploading.");
        ...
        >
          ...
          <div className="w-full mt-[50px] text-center">
            <p className="text-[14px] font-normal text-[#EAFBFF]">
              {isDragActive ? <span className="text-[#00D1FF]">Drop files here...</span> : <><span className="underline">Choose a file</span> or Drag and drop</>}
            </p>
