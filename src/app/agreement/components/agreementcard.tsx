...
const detectContentFormat = (content: string): string => {
...
interface AgreementCardProps {
  agreement: any; // TODO: Define proper agreement type
  printAgreement: (agreement: any) => void;
...
export const AgreementCard = ({
  ...
  printAgreement,
  toggleSignModal,
}: AgreementCardProps): React.JSX.Element => {
...
interface PendingAgreementCardProps {
  agreement: any; // TODO: Define proper agreement type
  printAgreement: (agreement: any) => void;
  toggleSignModal: () => void;
}
...
export const PendingAgreementCard = ({
  ...
  printAgreement,
  toggleSignModal,
}: PendingAgreementCardProps): React.JSX.Element => {
